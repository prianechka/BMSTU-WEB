...
// 2022-12-11 18:00:18.880742422 +0300 +03 m=+0.040808789
        ...
        "/api/v1/student-live-acts/{stud-number}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Параметр того, как выводить историю: текущую комнату(current) или общую историю перемещений (all)",
                        "name": "status",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/student-things-acts/{mark-number}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Параметр того, как выводить историю: текущего владельца(current) или общую историю (all)",
                        "name": "status",
                        "in": "query",
                        "required": true
                    }
