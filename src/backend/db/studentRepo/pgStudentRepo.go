...
func (pg *PgStudentRepo) GetAllStudents(page, size int) ([]objects.Student, error) {
	var (
...
func (pg *PgStudentRepo) GetStudentThings(id int, page, size int) ([]objects.Thing, error) {
	var (
